 ...
 * @author mcharfadi
 */
public record SingleClickOnGroupTool(String id, String label, List<String> iconURL, List<IDiagramElementDescription> targetDescriptions, String selectionDescriptionId,
                                              boolean appliesToDiagramRoot) implements ITool {

    public SingleClickOnGroupTool {
    ...
    public static Builder newSingleClickOnGroupTool(String id) {
    ...
    public static final class Builder {
        ...
        public SingleClickOnGroupTool build() {
            return new SingleClickOnGroupTool(this.id, this.label, this.iconURL, this.targetDescriptions, this.selectionDescriptionId, this.appliesToDiagramRoot);
        }
    }
