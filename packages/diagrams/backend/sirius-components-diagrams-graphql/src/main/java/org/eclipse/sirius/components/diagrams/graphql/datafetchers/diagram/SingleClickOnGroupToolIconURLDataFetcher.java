...
@QueryDataFetcher(type = "SingleClickOnGroupTool", field = "iconURL")
public class SingleClickOnGroupToolIconURLDataFetcher implements IDataFetcherWithFieldCoordinates<List<String>> {
