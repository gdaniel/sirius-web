...
public interface DiagramPackage extends EPackage {
    ...
    /**
     * The feature id for the '<em><b>Group Tools</b></em>' containment reference list. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     * @ordered
     */
    int DIAGRAM_PALETTE__GROUP_TOOLS = 4;
    ...
    /**
     * The meta object id for the '{@link org.eclipse.sirius.components.view.diagram.impl.GroupToolImpl <em>Group
     * Tool</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see org.eclipse.sirius.components.view.diagram.impl.GroupToolImpl
     * @see org.eclipse.sirius.components.view.diagram.impl.DiagramPackageImpl#getGroupTool()
     * @generated
     */
    int GROUP_TOOL = 36;
     ...
     * @ordered
     */
    int GROUP_TOOL__NAME = TOOL__NAME;
     ...
     * @ordered
     */
    int GROUP_TOOL__PRECONDITION_EXPRESSION = TOOL__PRECONDITION_EXPRESSION;
     ...
     * @ordered
     */
    int GROUP_TOOL__BODY = TOOL__BODY;
     ...
     * @ordered
     */
    int GROUP_TOOL__SELECTION_DESCRIPTION = TOOL_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int GROUP_TOOL__ICON_UR_LS_EXPRESSION = TOOL_FEATURE_COUNT + 1;

    /**
     * The number of structural features of the '<em>Group Tool</em>' class. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @generated
     * @ordered
     */
    int GROUP_TOOL_FEATURE_COUNT = TOOL_FEATURE_COUNT + 2;

    /**
     * The number of operations of the '<em>Group Tool</em>' class. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     * @ordered
     */
    int GROUP_TOOL_OPERATION_COUNT = TOOL_OPERATION_COUNT + 0;
    ...
    /**
     * Returns the meta object for the containment reference list
     * '{@link org.eclipse.sirius.components.view.diagram.DiagramPalette#getGroupTools <em>Group Tools</em>}'. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for the containment reference list '<em>Group Tools</em>'.
     * @see org.eclipse.sirius.components.view.diagram.DiagramPalette#getGroupTools()
     * @see #getDiagramPalette()
     * @generated
     */
    EReference getDiagramPalette_GroupTools();
    ...
    /**
     * Returns the meta object for class '{@link org.eclipse.sirius.components.view.diagram.GroupTool <em>Group
     * Tool</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for class '<em>Group Tool</em>'.
    ...
    /**
     * Returns the meta object for the containment reference
     * '{@link org.eclipse.sirius.components.view.diagram.GroupTool#getSelectionDescription <em>Selection
     * Description</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for the containment reference '<em>Selection Description</em>'.
     * @see org.eclipse.sirius.components.view.diagram.GroupTool#getSelectionDescription()
     * @see #getGroupTool()
     * @generated
     */
    EReference getGroupTool_SelectionDescription();

    /**
     * Returns the meta object for the attribute
     * '{@link org.eclipse.sirius.components.view.diagram.GroupTool#getIconURLsExpression <em>Icon UR Ls
     * Expression</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for the attribute '<em>Icon UR Ls Expression</em>'.
     * @see org.eclipse.sirius.components.view.diagram.GroupTool#getIconURLsExpression()
     * @see #getGroupTool()
     * @generated
     */
    EAttribute getGroupTool_IconURLsExpression();
    ...
    interface Literals {
        ...
        /**
         * The meta object literal for the '<em><b>Group Tools</b></em>' containment reference list feature. <!--
         * begin-user-doc --> <!-- end-user-doc -->
         *
         * @generated
         */
        EReference DIAGRAM_PALETTE__GROUP_TOOLS = eINSTANCE.getDiagramPalette_GroupTools();
        ...
        /**
         * The meta object literal for the '{@link org.eclipse.sirius.components.view.diagram.impl.GroupToolImpl
         * <em>Group Tool</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
         *
         * @see org.eclipse.sirius.components.view.diagram.impl.GroupToolImpl
         * @see org.eclipse.sirius.components.view.diagram.impl.DiagramPackageImpl#getGroupTool()
         * @generated
         */
        EClass GROUP_TOOL = eINSTANCE.getGroupTool();
         ...
         * @generated
         */
        EReference GROUP_TOOL__SELECTION_DESCRIPTION = eINSTANCE.getGroupTool_SelectionDescription();
         ...
         * @generated
         */
        EAttribute GROUP_TOOL__ICON_UR_LS_EXPRESSION = eINSTANCE.getGroupTool_IconURLsExpression();
