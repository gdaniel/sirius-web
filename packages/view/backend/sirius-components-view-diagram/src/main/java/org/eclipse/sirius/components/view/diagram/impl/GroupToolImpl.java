...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Group Tool</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.diagram.impl.GroupToolImpl#getSelectionDescription <em>Selection
 * Description</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.impl.GroupToolImpl#getIconURLsExpression <em>Icon UR Ls
 * Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupToolImpl extends ToolImpl implements GroupTool {
    /**
    ...
    protected EClass eStaticClass() {
        return DiagramPackage.Literals.GROUP_TOOL;
    }
    ...
    public NotificationChain basicSetSelectionDescription(SelectionDescription newSelectionDescription, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DiagramPackage.GROUP_TOOL__SELECTION_DESCRIPTION, oldSelectionDescription, newSelectionDescription);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setSelectionDescription(SelectionDescription newSelectionDescription) {
        if (newSelectionDescription != this.selectionDescription) {
            ...
            if (this.selectionDescription != null)
                msgs = ((InternalEObject) this.selectionDescription).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramPackage.GROUP_TOOL__SELECTION_DESCRIPTION, null, msgs);
            if (newSelectionDescription != null)
                msgs = ((InternalEObject) newSelectionDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DiagramPackage.GROUP_TOOL__SELECTION_DESCRIPTION, null, msgs);
            msgs = this.basicSetSelectionDescription(newSelectionDescription, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.GROUP_TOOL__SELECTION_DESCRIPTION, newSelectionDescription, newSelectionDescription));
    }
    ...
    public void setIconURLsExpression(String newIconURLsExpression) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.GROUP_TOOL__ICON_UR_LS_EXPRESSION, oldIconURLsExpression, this.iconURLsExpression));
    }
