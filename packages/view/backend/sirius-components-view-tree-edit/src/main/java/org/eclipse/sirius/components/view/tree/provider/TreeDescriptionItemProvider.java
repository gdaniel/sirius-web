...
public class TreeDescriptionItemProvider extends RepresentationDescriptionItemProvider {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(TreePackage.Literals.TREE_DESCRIPTION__CONTEXT_MENU_ENTRIES, TreeFactory.eINSTANCE.createContributedTreeItemContextMenuEntry()));
    }
