...
public class TreeItemProviderAdapterFactory extends TreeAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
    ...
    /**
     * This keeps track of the one adapter used for all
     * {@link org.eclipse.sirius.components.view.tree.ContributedTreeItemContextMenuEntry} instances. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected ContributedTreeItemContextMenuEntryItemProvider contributedTreeItemContextMenuEntryItemProvider;

    /**
     * This creates an adapter for a
     * {@link org.eclipse.sirius.components.view.tree.ContributedTreeItemContextMenuEntry}. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
    ...
    public Adapter createContributedTreeItemContextMenuEntryAdapter() {
        if (this.contributedTreeItemContextMenuEntryItemProvider == null) {
            this.contributedTreeItemContextMenuEntryItemProvider = new ContributedTreeItemContextMenuEntryItemProvider(this);
        }

        return this.contributedTreeItemContextMenuEntryItemProvider;
    }
    ...
    public void dispose() {
        ...
        if (this.contributedTreeItemContextMenuEntryItemProvider != null)
            this.contributedTreeItemContextMenuEntryItemProvider.dispose();
    }
