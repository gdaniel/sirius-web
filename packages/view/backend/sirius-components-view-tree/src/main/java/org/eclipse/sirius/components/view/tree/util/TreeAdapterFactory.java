...
public class TreeAdapterFactory extends AdapterFactoryImpl {
    ...
    protected TreeSwitch<Adapter> modelSwitch = new TreeSwitch<>() {
        ...
        @Override
        public Adapter caseContributedTreeItemContextMenuEntry(ContributedTreeItemContextMenuEntry object) {
            return TreeAdapterFactory.this.createContributedTreeItemContextMenuEntryAdapter();
        }
     ...
     * @generated
     */
    public Adapter createContributedTreeItemContextMenuEntryAdapter() {
        return null;
    }
