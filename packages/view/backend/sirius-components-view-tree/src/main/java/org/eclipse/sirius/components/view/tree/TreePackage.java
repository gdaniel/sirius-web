...
public interface TreePackage extends EPackage {
    ...
    /**
     * The meta object id for the
     * '{@link org.eclipse.sirius.components.view.tree.impl.ContributedTreeItemContextMenuEntryImpl <em>Contributed Tree
     * Item Context Menu Entry</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see org.eclipse.sirius.components.view.tree.impl.ContributedTreeItemContextMenuEntryImpl
     * @see org.eclipse.sirius.components.view.tree.impl.TreePackageImpl#getContributedTreeItemContextMenuEntry()
     * @generated
     */
    int CONTRIBUTED_TREE_ITEM_CONTEXT_MENU_ENTRY = 7;
     ...
     * @ordered
     */
    int CONTRIBUTED_TREE_ITEM_CONTEXT_MENU_ENTRY__NAME = TREE_ITEM_CONTEXT_MENU_ENTRY__NAME;
     ...
     * @ordered
     */
    int CONTRIBUTED_TREE_ITEM_CONTEXT_MENU_ENTRY__LABEL_EXPRESSION = TREE_ITEM_CONTEXT_MENU_ENTRY__LABEL_EXPRESSION;
     ...
     * @ordered
     */
    int CONTRIBUTED_TREE_ITEM_CONTEXT_MENU_ENTRY__ICON_URL_EXPRESSION = TREE_ITEM_CONTEXT_MENU_ENTRY__ICON_URL_EXPRESSION;
     ...
     * @ordered
     */
    int CONTRIBUTED_TREE_ITEM_CONTEXT_MENU_ENTRY__PRECONDITION_EXPRESSION = TREE_ITEM_CONTEXT_MENU_ENTRY__PRECONDITION_EXPRESSION;
     ...
     * @ordered
     */
    int CONTRIBUTED_TREE_ITEM_CONTEXT_MENU_ENTRY__CONTRIBUTION_ID = TREE_ITEM_CONTEXT_MENU_ENTRY_FEATURE_COUNT + 0;

    /**
     * The number of structural features of the '<em>Contributed Tree Item Context Menu Entry</em>' class. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     * @ordered
     */
    int CONTRIBUTED_TREE_ITEM_CONTEXT_MENU_ENTRY_FEATURE_COUNT = TREE_ITEM_CONTEXT_MENU_ENTRY_FEATURE_COUNT + 1;

    /**
     * The number of operations of the '<em>Contributed Tree Item Context Menu Entry</em>' class. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @generated
     * @ordered
     */
    int CONTRIBUTED_TREE_ITEM_CONTEXT_MENU_ENTRY_OPERATION_COUNT = TREE_ITEM_CONTEXT_MENU_ENTRY_OPERATION_COUNT + 0;
    ...
    /**
     * Returns the meta object for class
     * '{@link org.eclipse.sirius.components.view.tree.ContributedTreeItemContextMenuEntry <em>Contributed Tree Item
     * Context Menu Entry</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for class '<em>Contributed Tree Item Context Menu Entry</em>'.
     * @see org.eclipse.sirius.components.view.tree.ContributedTreeItemContextMenuEntry
     * @generated
     */
    EClass getContributedTreeItemContextMenuEntry();

    /**
     * Returns the meta object for the attribute
     * '{@link org.eclipse.sirius.components.view.tree.ContributedTreeItemContextMenuEntry#getContributionId
     * <em>Contribution Id</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for the attribute '<em>Contribution Id</em>'.
     * @see org.eclipse.sirius.components.view.tree.ContributedTreeItemContextMenuEntry#getContributionId()
     * @see #getContributedTreeItemContextMenuEntry()
     * @generated
     */
    EAttribute getContributedTreeItemContextMenuEntry_ContributionId();
    ...
    interface Literals {
        ...
        /**
         * The meta object literal for the
         * '{@link org.eclipse.sirius.components.view.tree.impl.ContributedTreeItemContextMenuEntryImpl <em>Contributed
         * Tree Item Context Menu Entry</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
         *
         * @see org.eclipse.sirius.components.view.tree.impl.ContributedTreeItemContextMenuEntryImpl
         * @see org.eclipse.sirius.components.view.tree.impl.TreePackageImpl#getContributedTreeItemContextMenuEntry()
         * @generated
         */
        EClass CONTRIBUTED_TREE_ITEM_CONTEXT_MENU_ENTRY = eINSTANCE.getContributedTreeItemContextMenuEntry();
         ...
         * @generated
         */
        EAttribute CONTRIBUTED_TREE_ITEM_CONTEXT_MENU_ENTRY__CONTRIBUTION_ID = eINSTANCE.getContributedTreeItemContextMenuEntry_ContributionId();
