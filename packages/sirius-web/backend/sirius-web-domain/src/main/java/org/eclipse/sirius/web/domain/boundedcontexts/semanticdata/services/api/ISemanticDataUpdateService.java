...
public interface ISemanticDataUpdateService {
    ...
    IResult<Void> addDependency(ICause cause, UUID semanticDataId, UUID dependencySemanticDataId);

    IResult<Void> removeDependency(ICause cause, UUID semanticDataID, UUID dependencySemanticDataId);
