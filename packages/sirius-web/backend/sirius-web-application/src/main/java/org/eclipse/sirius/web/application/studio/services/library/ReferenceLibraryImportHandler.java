            ...
            if (editingContext instanceof EditingContext siriusWebEditingContext) {
                ...
                for (Library library : libraries) {
                    ...
                    if (optionalSemanticData.isPresent()) {
                        if (optionalSemanticData.get().getDependencies().stream().anyMatch(dependency -> dependency.dependencySemanticDataId().getId().equals(library.getSemanticData().getId()))) {
                            ...
                            this.semanticDataUpdateService.addDependency(input, optionalSemanticData.get().getId(), library.getSemanticData().getId());
                        }
                    }
                }
