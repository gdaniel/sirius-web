 ...
 *******************************************************************************/
import { OmniboxCommandDialogComponentProps } from '@eclipse-sirius/sirius-components-omnibox';
...
import { PublishStudioState } from './PublishStudioOmniboxCommandDialog.types';
...
export const PublishStudioOmniboxCommandDialog = ({ onClose }: OmniboxCommandDialogComponentProps) => {
  ...
  const onPublishStudio = () => {
    publishLibraries(project.id, state.version, state.description);
    onClose();
  };
