...
export interface UsePublishLibrariesValue {
  publishLibraries: (projectId: string, version: string, description: string) => void;
  loading: boolean;
...
export interface GQLPublishLibrariesSuccessPayload extends GQLPublishLibrariesPayload {
  libraries: string[];
}
