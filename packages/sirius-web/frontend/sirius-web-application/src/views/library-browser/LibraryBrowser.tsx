...
const LibrariesTable = memo(({}: LibrariesTableProps) => {
  const [pagination, setPagination] = useState<MRT_PaginationState>({
    pageIndex: 0,
    pageSize: 20,
  });
  const { data: libraries, totalLibrariesCount } = useLibraries(pagination.pageIndex, pagination.pageSize);
