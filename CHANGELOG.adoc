...
- https://github.com/eclipse-sirius/sirius-web/issues/4462[#4462] [sirius-web] Add support for library publication and visualization.
- https://github.com/eclipse-sirius/sirius-web/issues/4428[#4428] [core] Allow the command palette to run regular commands.
